...
AddonTitle="[COLOR ghostwhite]KrajnaTV Wizard[/COLOR]"
thumbnailPath = xbmc.translatePath('special://userdata/Thumbnails');
cachePath = os.path.join(xbmc.translatePath('special://home'), 'cache')
tempPath = xbmc.translatePath('special://temp')
addonPath = os.path.join(os.path.join(xbmc.translatePath('special://home'), 'addons'),'plugin.video.krajnatv')
...
MaintTitle="[COLOR white]KrajnaTV Maintenance[/COLOR]"
...
def clearCache():
    ...
    dialog = xbmcgui.Dialog()
    xbmc.executebuiltin('Notification(Clean,[COLOR white]Cache cleaned[/COLOR],2000,special://home/addons/plugin.video.krajnatv/icon.png)')
...
def deleteThumbnails():
    ...
    try:
        ...
        pass
	xbmc.executebuiltin("Container.Refresh")
	xbmc.executebuiltin('Notification(Clean,[COLOR white]Thumbnails cleaned[/COLOR],2000,special://home/addons/plugin.video.krajnatv/icon.png)')
        ...
        for root, dirs, files in os.walk(purgePath):
            ...
            if file_count > 0:            
                ...
                for d in dirs:
                    shutil.rmtree(os.path.join(root, d))
                dialog = xbmcgui.Dialog()
                xbmc.executebuiltin('Notification(Purged,[COLOR white]All packages purged[/COLOR],2000,special://home/addons/plugin.video.krajnatv/icon.png)')
            else:
                dialog = xbmcgui.Dialog()
                xbmc.executebuiltin('Notification(Not Required,[COLOR white]No Packages to Purge[/COLOR],2000,special://home/addons/plugin.video.krajnatv/icon.png)')
	xbmc.executebuiltin("Container.Refresh")
...
def autocleannow():
    ...
    xbmc.executebuiltin('Notification(Clean,[COLOR white]All temporary data has been cleaned[/COLOR],2000,special://home/addons/plugin.video.krajnatv/icon.png)')
    xbmc.executebuiltin("Container.Refresh")
