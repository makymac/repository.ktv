...
import maintenance
AddonID = 'plugin.video.krajnatv'
AddonTitle = 'KrajnaTV'
Images=xbmc.translatePath(os.path.join('special://home','addons',AddonID,'resources/art/'));
fanart = Images+'fanart.jpg'
icon = Images+'icon.png'
VAddon = xbmcaddon.Addon('plugin.video.krajnatv')
ADDON=xbmcaddon.Addon(id='plugin.video.krajnatv')
...
def PVRbeta():
	...
	BetaPVR = PVRSimple+'krajnatv.m3u8'
	time.sleep(1)
...
def SpeedChoice():
	...
	if choice == 0:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.krajnatv/speedtest.py")') ###############
	if choice == 1:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.krajnatv/fastload.py")')  ###############
...
def iVueInt():
	...
	AddoniVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.krajnatv/resources','ivueset.xml')) ###############
	...
	xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.krajnatv/fullivue.py")') ###############
